...
const char* CreateProgramTestFormat= "insert into program_test(subject_id,example_in,example_out) values('%d','%s', '%s')";
const char* CreateProgramDataFormat = "insert into program_data(subject_id,data_in,data_out) values('%d','%s', '%s')";
const char* GetAllSubjectFormat = "select * from subject";
const char* GetProgramTestFormat = "select * from program_test where subject_id=%d";
const char* GetProgramDataFormat = "select * from program_data where subject_id=%d";
...
const char* GetAllTestPaperFormat = "select * from test_paper";